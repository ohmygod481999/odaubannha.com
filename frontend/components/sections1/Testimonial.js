        ...
        <div className="row">
          ...
          >
            {comments.map((comment) => {
              const { name1, content1, image1, name2, content2, image2 } =
                comment;
              return (
                <div
                  className="ls-slide"
            ...
            >
              ...
              <p
                ...
                data-ls="offsetyin:-100; durationin:800; delayin:800; easingin:easeOutExpo; durationout:400; parallaxlevel:0;"
              >
                "I'm really happy to purchased this item! It has an incredible
                slider builder! It will be the base of my future projects!"
              </p>
              <img
                width={160}
                height={160}
              ...
              <p
                ...
                data-ls="offsetyin:100; durationin:800; delayin:1500; easingin:easeOutExpo; durationout:400; parallaxlevel:0;"
              >
                "Guys, you are fantastic! You created the most user friendly
                slider I ever used!"
              </p>
            </div> */}
            {/* Slide 2*/}
            ...
            >
              ...
              <p
                ...
                data-ls="offsetyin:100; durationin:800; delayin:800; easingin:easeOutExpo; durationout:400; parallaxlevel:0;"
              >
                "Absolutely the best slider I tried! It's far worth the price.
              ...
              <p
                ...
                data-ls="offsetyin:-100; durationin:800; delayin:1500; easingin:easeOutExpo; durationout:400; parallaxlevel:0;"
              >
                "The most intuitive Interface I have ever used. Incredible
