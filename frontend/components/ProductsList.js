  ...
  useEffect(() => {
    ...
    switch (true) {
      ...
      case region === "all" && price === "all": {
        const result = filterDatas.filter((filterData) => {
          const checkCategoriFilteredData = filterData.categories.some(
            ...
            <div className="top-filter pb-15 border-bottom-1-gray">
              <div className="row">
                <div className="col-md-3 col-lg-6 col-xl-7">
                  <label>Tổng số có {productsData.length} kết quả </label>
                </div>
                  ...
                  <ul className="list-bottom select-option">
                    <li>
                      <input
                        ...
                        type="radio"
                        name="price"
                        onChange={_onChangeCheckBox("price")}
                        min={"all"}
                        max={"all"}
                      />
                      <label htmlFor="feature0">Tất cả</label>
                    </li>
                    <li>
                      <input
                        id="feature1"
                        ...
                        max={4}
                      />
                      <label htmlFor="feature1">2 tỉ - 4 tỉ</label>
                    </li>
                    <li>
                      <input
                        id="feature-2"
                    ...
                    <li>
                      <input
                        ...
                        max={10}
                      />
                      <label htmlFor="feature3">8 tỷ - 10 tỷ</label>
                    </li>
                  </ul>
                </div>
              </div>
