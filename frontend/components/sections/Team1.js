    ...
    return (
        <div className="section pb_70">
            <div className="container">
                ...
                <div className="row justify-content-center">
                    <div
                        className="col-lg-3 col-sm-6 animation"
                        data-animation="fadeInUp"
                        data-animation-delay="0.03s"
                    >
                        <div className="team_box team_style1 radius_all_10">
                            <div className="team_img">
                                <img
                                    src="/assets/images/team_img1.jpg"
                                    alt="team_img1"
                                />
                    ...
                    >
                        <div className="team_box team_style1 radius_all_10">
                            <div className="team_img">
                                <img
                                    src="/assets/images/team_img2.jpg"
                                    alt="team_img2"
                                />
                                <ul className="social_icons social_white">
                                    <li>
                    ...
                    >
                        <div className="team_box team_style1 radius_all_10">
                            <div className="team_img">
                                <img
                                    src="/assets/images/team_img3.jpg"
                                    alt="team_img3"
                                />
                                <ul className="social_icons social_white">
                                    <li>
                    ...
                    >
                        <div className="team_box team_style1 radius_all_10">
                            <div className="team_img">
                                <img
                                    src="/assets/images/team_img4.jpg"
                                    alt="team_img4"
                                />
                                <ul className="social_icons social_white">
                                    <li>
